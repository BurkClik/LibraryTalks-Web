<template>
  <div class="signup min-h-screen flex items-center justify-center bg-gray-50
        ...
        class="mt-8 space-y-6">
          ...
          <div class="rounded-md shadow-sm -space-y-px">
            <div>
              ...
              class=" appearance-none rounded-none relative block w-full px-3 py-2 border-gray-300
               placeholder-gray-500 text-gray-500 rounded-t-md focus:outline-none
            ...
            <div>
              ...
              class=" appearance-none rounded-none relative block w-full px-3 py-2 border-gray-300
               placeholder-gray-500 text-gray-500 rounded-b-md focus:outline-none
               focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm">
            </div>
          </div>
